...
public class BillingService
{
    ...
    const string subscriptionName = "billing-subscription"; // Subscription name
    ...
    public async Task ReceiveMessageAsync()
    {
        ...
        processor.ProcessMessageAsync += async args =>
        {
            ...
            Console.WriteLine($"BillingService received OrderCreated for {body}");

            // Shipping logic here (e.g., process order)
